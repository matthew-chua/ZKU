...
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[0]); // line circom 334
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[1],&lvar[221],&circuitConstants[1]); // line circom 335
Fr_eq(&expaux[2],&lvar[221],&circuitConstants[437]); // line circom 335
Fr_lor(&expaux[0],&expaux[1],&expaux[2]); // line circom 335
...
Fr_eq(&expaux[0],&lvar[221],&circuitConstants[1]); // line circom 340
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[219];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 2]); // line circom 340
// end load src
...
PFrElement aux_dest = &lvar[219];
// load src
Fr_sub(&expaux[3],&lvar[221],&circuitConstants[3]); // line circom 340
Fr_add(&expaux[1],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[3])) + 445)]); // line circom 340
Fr_add(&expaux[0],&expaux[1],&lvar[220]); // line circom 340
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
...
// load src
Fr_mul(&expaux[0],&lvar[219],&lvar[219]); // line circom 341
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 5)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 5)]); // line circom 342
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[437]); // line circom 343
if(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[221],&circuitConstants[1]); // line circom 344
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[222];
// load src
Fr_sub(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 344
// end load src
...
// load src
Fr_mul(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 225)],&lvar[219]); // line circom 345
Fr_add(&expaux[0],&lvar[222],&expaux[2]); // line circom 345
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_eq(&expaux[0],&lvar[221],&circuitConstants[1]); // line circom 346
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 664)];
// load src
Fr_sub(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 346
// end load src
...
// load src
Fr_mul(&expaux[2],&signalValues[mySignalStart + 444],&lvar[219]); // line circom 348
Fr_add(&expaux[0],&signalValues[mySignalStart + 882],&expaux[2]); // line circom 348
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &lvar[221];
// load src
Fr_add(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 334
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[0]); // line circom 334
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 72
while(Fr_isTrue(&expaux[0])){
{
...
Fr_eq(&expaux[0],&lvar[3],&circuitConstants[1]); // line circom 75
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&signalValues[mySignalStart + 2]); // line circom 79
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
PFrElement aux_dest = &lvar[3];
// load src
Fr_add(&expaux[0],&lvar[3],&circuitConstants[3]); // line circom 72
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[5]); // line circom 72
...
Fr_gt(&expaux[0],&lvar[18],&circuitConstants[1]); // line circom 23
while(Fr_isTrue(&expaux[0])){
{
...
Fr_sub(&expaux[1],&lvar[18],&circuitConstants[5]); // line circom 31
Fr_div(&expaux[0],&expaux[1],&circuitConstants[5]); // line circom 31
{
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[3]); // line circom 32
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[18];
// load src
Fr_sub(&expaux[0],&lvar[18],&circuitConstants[5]); // line circom 23
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_gt(&expaux[0],&lvar[18],&circuitConstants[1]); // line circom 23
